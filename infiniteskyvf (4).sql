...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2025 a las 04:01:39
...
(4, 'Meade - Telescopio LX200 12\" - Telescopio avanzado Schmidt-Cassegrain para astrónomos expertos - Montura computerizada altazimutal/ecuatorial - Apertura ultra-grande de 304mm (12\") ', 'Meade - Telescopio LX200 12\" - Telescopio avanzado Schmidt-Cassegrain - Ideal para la observación de objetos celestes con detalles.', 'El Telescopio LX200 12\" ACF de Meade representa la cúspide de la tecnología astronómica amateur, combinando un sistema óptico Advanced Coma-Free (ACF) de 12\" (304mm) con una montura computerizada de alta precisión. Este instrumento está diseñado para astrofotografía de largo alcance y observación de objetos celestes con detalles sin precedentes.', 40700, 'https://http2.mlstatic.com/D_NQ_NP_2X_676168-CBT84219876103_042025-F-telescopio-astronomico-profesional-70400mm-monocular-200x.webp\r\nhttps://http2.mlstatic.com/D_NQ_NP_2X_882459-CBT83925027424_042025-F-telescopio-astronomico-profesional-70400mm-monocular-200x.webp\r\nhttps://http2.mlstatic.com/D_NQ_NP_2X_843214-CBT84219856185_042025-F-telescopio-astronomico-profesional-70400mm-monocular-200x.webp', 3, 1, 7, NULL),
...
(14, 'Libro Cosmos de Carl Sagan - Divulgación científica - Edición actualizada con prólogo de Neil deGrasse Tyson - Incluye ilustraciones a todo color y nuevos hallazgos astronómicos - 384 páginas - Editorial Planeta - ISBN 978-8408198901.', 'Libro Cosmos - Carl Sagan - Clásico de astronomía y ciencia - Editorial Planeta - ISBN 978-8408198901.', '\"Cosmos\", la obra icónica de Carl Sagan, es un viaje literario a través del universo que combina astronomía, filosofía e historia de la ciencia. Esta edición especial incluye:\r\n13 capítulos que exploran desde el Big Bang hasta el origen de la vida, actualizaciones científicas basadas en descubrimientos recientes e ilustraciones a color de nebulosas, planetas y telescopios espaciales', 251, 'https://m.media-amazon.com/images/I/61WgF7xPR2L._SL1181_.jpg\r\nhttps://m.media-amazon.com/images/I/51YBcb-oyeL.jpg\r\nhttps://m.media-amazon.com/images/I/81obLhHv-NL._SL1500_.jpg', 30, 4, 14, NULL),
...
ALTER TABLE `carrito`
  ...
  ADD KEY `fk_carrito_producto` (`Id_prod`);
...
--
ALTER TABLE `carrito`
  ADD CONSTRAINT `fk_carrito_producto` FOREIGN KEY (`Id_prod`) REFERENCES `producto` (`id_prod`) ON DELETE CASCADE ON UPDATE CASCADE;
